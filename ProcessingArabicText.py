...
def process_text(text):
    ...
    tokens = [token for token in tokens if token not in arabic_stop_words and token.isalpha()]
    tokens = [arabic_stemmer.stem(token) for token in tokens]
    return tokens
...
def main():
    ...
    input_dir = "C:/Users/dogaa/Desktop/Arabic-AarssenBos"
    output_dir = "C:/Users/dogaa/Desktop/ProcessedArabic"
