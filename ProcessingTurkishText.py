...
#be sure to do pip install -r requirements.txt to import the turkish stemmer
...
def process_text(text):
    ...
    tokens = [token for token in tokens if token not in turkish_stop_words and token.isalpha()]
    tokens = [turkish_stemmer.stemWord(token) for token in tokens]
    return tokens
...
def main():
    ...
    input_dir = "C:/Users/dogaa/Desktop/Turkish-AarssenBos"
    output_dir = "C:/Users/dogaa/Desktop/ProcessedTurkish"
